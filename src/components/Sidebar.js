...
<div className='px-6 py-6 border-t border-gray-700'>
    ...
    <ul className='mt-3 text-white'>
        <li className='mt-3'>
            <Link to="/" href="" className='bg-slate-600 text-white rounded-md px-6 py-2 w-24 inline-flex'>
        ...
        <li className='mt-3'>
            <Link to="/cases" href="" className='bg-slate-600 text-white rounded-md px-6 py-2 w-24 inline-flex'>
                 <svg className="svg-icon h-6 w-6 flex-shrink-0" viewBox="0 0 24 24">
